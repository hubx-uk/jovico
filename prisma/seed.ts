...
async function main() {
    ...
    // ─── Admin ──────────────────────────────────────────────────
    const hashedAdminPass = await bcrypt.hash('jovico@admin2024', 12)
    ...
    await prisma.admin.upsert({
        where: { email: 'editor@jovicobikes.com' },
        update: {},
        create: {
            email: 'editor@jovicobikes.com',
            password: hashedAdminPass,
            name: 'Chidi Editor',
    ...
    const customers = await Promise.all([
        ...
        prisma.customer.upsert({
            ...
            create: {
                ...
                password: customerPass,
                phone: '+2348012345003',
                address: '5 Kofo Abayomi St, Victoria Island, Lagos',
            },
        }),
        prisma.customer.upsert({
    ...
    const servicesData = [
        {
            ...
            description:
                'A thorough inspection and adjustment of all key components including brakes, gears, tyres, and battery health check.',
            price: 8500,
            priceNote: null,
            duration: '2–3 hours',
            icon: 'wrench',
        ...
        },
        {
            ...
            description:
                'Complete disassembly, cleaning, lubrication, and reassembly. Includes motor diagnostics and battery calibration.',
            price: 25000,
            priceNote: null,
            duration: '1–2 days',
            icon: 'settings',
        ...
        },
        {
            ...
            description:
                'Full battery health assessment, cell balancing, firmware updates, and replacement if required.',
            price: 5000,
        ...
        },
        {
            ...
            description:
                'Fast and reliable tyre and tube replacement service with puncture-resistant tyres.',
            price: 4500,
            priceNote: null,
            duration: '1 hour',
            icon: 'circle',
        ...
        },
        {
            ...
            description:
                'Expert repair of hub motors, mid-drive systems, controllers, and displays.',
            price: 15000,
        ...
        },
        {
            ...
            description:
                'Hydraulic and mechanical brake adjustment, pad replacement, and hydraulic bleed service.',
            price: 6000,
            priceNote: null,
            duration: '1–2 hours',
            icon: 'shield',
    ...
    const bikeSpecs = {
        ...
        explorer750: {
            ...
            gears: 'Shimano Deore 10-sp',
            display: 'Bafang DPC-18 Colour',
            suspension: '100mm Fork',
        },
        cargoRunner: {
            motor: '500W Rear Hub',
        ...
        streetGlide: {
            motor: '350W Bosch Active Line+',
            battery: '500Wh Integrated',
            range: '100km',
            topSpeed: '35km/h',
            weight: '20kg',
            frame: 'Premium 6061 Al',
    ...
    const productsData = [
        {
            ...
            description:
                'The ultimate Lagos urban commuter. 500W rear hub motor, 36V 12Ah battery, 60km range. Handles Lekki-Ajah in style.',
            price: 485000,
            salePrice: null,
            sku: 'JVC-CC-PRO-001',
            stock: 8,
        ...
        },
        {
            ...
            description:
                'Built for Lagos terrain and beyond. 750W Bafang mid-drive, 48V 17.5Ah, 80km range for serious off-road adventures.',
            price: 720000,
            salePrice: null,
        ...
        },
        {
            ...
            description:
                "Nigeria's premier delivery and family eBike. 250kg payload capacity, 500W motor, 70km range.",
            price: 550000,
            salePrice: null,
            sku: 'JVC-CARGO-001',
            stock: 4,
        ...
        },
        {
            ...
            slug: 'jovico-fold-go',
            description:
                'Compact, lightweight, ultra-portable. Fits in your boot or under your desk. 250W motor, 20" wheels.',
            price: 295000,
            salePrice: 275000,
            sku: 'JVC-FOLD-001',
            stock: 12,
        ...
        },
        {
            ...
            description:
                'Sleek, fast, stylish. Integrated battery, Gates carbon belt drive, Bosch motor. 100km range.',
            price: 890000,
            salePrice: null,
            sku: 'JVC-SG-S1-001',
            stock: 3,
            ...
            type: ProductType.BIKE,
            brand: 'Jovico',
            specs: bikeSpecs.streetGlide,
            featured: true,
        },
        {
            name: 'Jovico TrailBlaze 29',
            slug: 'jovico-trailblaze-29',
            description:
                '29" trail-ready hardtail. Powerful 1000W hub motor, full air suspension fork, Shimano XT drivetrain.',
            price: 980000,
            salePrice: null,
            sku: 'JVC-TB-29-001',
            stock: 2,
        ...
        {
            name: 'Premium Helmet — Matte Black',
            slug: 'premium-helmet-matte-black',
            description:
                'CPSC-certified full-face helmet with integrated visor. Lightweight polycarbonate shell, EPS liner.',
            price: 35000,
            salePrice: 28000,
            sku: 'ACC-HELM-001',
            stock: 25,
        ...
        {
            name: 'Smart eBike Lock — Fingerprint',
            slug: 'smart-ebike-lock-fingerprint',
            description:
                'Fingerprint + Bluetooth lock. 120dB alarm, IP67 waterproof, 6-month battery life.',
            price: 22000,
            salePrice: null,
            sku: 'ACC-LOCK-001',
            stock: 40,
    ...
    const postsData = [
        ...
        },
        {
            ...
            excerpt:
                'We put the Explorer 750X through its paces on Lagos roads and Ogun State trails. Here is our honest verdict.',
            content:
            ...
            tags: 'review,explorer,mountain-bike,test',
            author: 'Tayo Adeleke',
            published: true,
            featured: false,
            views: 763,
        ...
        },
        {
            ...
            excerpt:
                'With petrol prices at historic highs, we crunch the numbers on eBike ownership costs versus petrol alternatives in Nigeria.',
            content:
                '<h2>The Petrol Price Reality</h2><p>Nigerian petrol prices have risen dramatically in recent years following subsidy removal. At current prices, a typical motorbike commuter in Lagos spends ₦25,000–40,000 per month on fuel alone.</p><h2>eBike Running Costs</h2><p>An eBike covering the same distance costs approximately ₦2,500–4,500 per month in electricity. That is a saving of ₦20,000–35,000 every single month — enough to pay off a mid-range Jovico eBike in under 24 months.</p><h2>Total Cost of Ownership</h2><p>Factor in reduced maintenance costs (no oil changes, spark plugs, or exhaust repairs) and most Jovico eBike owners find their bikes cost-neutral within 18–22 months of purchase.</p>',
            category: PostCategory.NEWS,
            tags: 'economics,petrol,savings,2025',
            author: 'Kemi Oladele',
            published: false,
            featured: false,
            views: 0,
    ...
    const ordersData = [
        {
            ...
            addr: { street: '14 Adeola Odeku St', city: 'Victoria Island', state: 'Lagos' },
            num: 'JVB-ORDER-001',
        },
        {
            customer: customers[0],
            product: createdProducts[6],
            qty: 2,
            status: OrderStatus.DELIVERED,
            payment: PaymentStatus.PAID,
            addr: { street: '14 Adeola Odeku St', city: 'Victoria Island', state: 'Lagos' },
        ...
        },
        {
            ...
            payment: PaymentStatus.PAID,
            addr: { street: '22 Bode Thomas St', city: 'Surulere', state: 'Lagos' },
            num: 'JVB-ORDER-003',
        },
        {
            ...
            addr: { street: '5 Kofo Abayomi St', city: 'Victoria Island', state: 'Lagos' },
            num: 'JVB-ORDER-004',
        },
        {
            ...
            payment: PaymentStatus.UNPAID,
            addr: { street: '18 Awolowo Road', city: 'Ikoyi', state: 'Lagos' },
            num: 'JVB-ORDER-005',
        },
        {
            customer: customers[1],
    ...
    const bookingsData = [
        {
            ...
            email: 'emeka@gmail.com',
            phone: '+2348012345001',
            serviceSlug: 'basic-tune-up',
            date: futureDate(2),
            status: BookingStatus.CONFIRMED,
            notes: 'Shimano gears slipping on 3rd',
        },
        {
            name: 'Ngozi Adeyemi',
            email: 'ngozi@hotmail.com',
            phone: '+2348012345002',
            serviceSlug: 'battery-diagnostics',
            date: futureDate(4),
            status: BookingStatus.PENDING,
            notes: 'Battery draining faster than usual',
        },
        {
            name: 'Chukwuma Peters',
            email: 'chukwuma@gmail.com',
            phone: '+2348056781234',
            serviceSlug: 'full-service-overhaul',
            date: futureDate(7),
            status: BookingStatus.PENDING,
            notes: 'Annual full service — bike is 14 months old',
        },
        {
            name: 'Tunde Fashola',
            email: 'tunde@yahoo.com',
            phone: '+2348012345003',
            serviceSlug: 'tyre-tube-replacement',
            date: futureDate(-3),
            status: BookingStatus.COMPLETED,
            notes: 'Front tyre puncture',
        },
        {
            name: 'Amaka Obi',
            email: 'amaka@icloud.com',
            phone: '+2348099887766',
            serviceSlug: 'motor-electronics-repair',
            date: futureDate(10),
            status: BookingStatus.CONFIRMED,
            notes: 'Motor making clicking sound above 20km/h',
        },
        {
            name: 'Segun Martins',
            email: 'segun.m@gmail.com',
            phone: '+2348055443322',
            serviceSlug: 'brake-adjustment-bleed',
            date: futureDate(1),
            status: BookingStatus.PENDING,
            notes: 'Front hydraulic disc feels spongy',
        },
    ]
    for (const b of bookingsData) {
        ...
        const existing = await prisma.booking.findFirst({
            where: { email: b.email, serviceId: service.id },
        })
        if (!existing) {
    ...
    const messagesData = [
        {
            ...
            message:
                'Hi, is the City Cruiser Pro available in red? And do you offer installmental payment?',
            read: false,
        },
        {
            name: 'Femi Ogunlana',
            email: 'femi.o@yahoo.com',
            phone: null,
            subject: 'Service Booking',
            message: 'Can I drop off my bike without an appointment for a quick tyre change?',
            read: false,
        },
        {
            name: 'Chioma Nzeka',
            ...
            message:
                'My order JVB-ORDER-003 has been in shipped status for 4 days. When should I expect delivery?',
            read: true,
        },
        {
            name: 'Rotimi Adebayo',
            email: 'rotimi.a@outlook.com',
            phone: null,
            subject: 'Partnership',
            message:
                'We run a corporate fleet management company and are interested in bulk purchasing 20+ eBikes for our staff. Can we schedule a meeting?',
            read: false,
        },
    ]
    ...
    const settingsData = [
        ...
        { key: 'hero_video_title', value: 'Feel the Electric Difference' },
        {
            ...
            value: 'See what riding a Jovico eBike through Lagos truly feels like.',
        },
    ]
    ...
    console.log('─────────────────────────────────────────')
    console.log('🔐 Admin:    admin@jovicobikes.com / jovico@admin2024')
