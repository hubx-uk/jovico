    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-slate-950">
        <div className="jv-container">
          <p className="text-green-400 font-semibold text-sm uppercase tracking-wider mb-2">Gear Up</p>
          <h1 className="text-5xl md:text-6xl font-extrabold text-white mb-4">Accessories</h1>
          <p className="text-slate-400 text-lg max-w-xl">
            Everything you need to ride safely and stylishly in Lagos. Premium accessories
            for every eBike rider.
          </p>
        </div>
      </section>
      ...
      <section className="jv-section bg-white">
        <div className="jv-container">
          <h2 className="text-3xl font-extrabold text-slate-900 mb-8">Browse by Category</h2>
        ...
        <div className="jv-container">
          ...
          {accessories.length === 0 ? (
            <div className="text-center py-20 jv-card">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Accessories Coming Soon</h3>
              <p className="text-slate-500 mb-6">
                We're stocking up our accessories range. Get notified when we launch!
              </p>
              <a
