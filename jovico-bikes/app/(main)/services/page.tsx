...
import { CheckCircle2, Clock, ArrowRight, Wrench, Zap, Battery, Circle, Settings, Shield, MessageCircle } from "lucide-react";
    ...
    <>
      ...
      <section className="pt-32 pb-20 bg-slate-950 relative overflow-hidden">
        ...
        <div className="jv-container relative z-10">
          ...
          <p className="text-slate-400 text-lg max-w-xl leading-relaxed mb-8">
            Our fully-equipped Lagos workshop keeps your electric bike in peak condition.
            Certified technicians, genuine parts, fast turnaround.
          </p>
      ...
      <section className="jv-section bg-white">
        <div className="jv-container">
          <div className="text-center mb-12">
            <p className="text-green-500 font-semibold text-sm uppercase tracking-wider mb-2">Most Popular</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featured.map((service) => {
              ...
              return (
                <div key={service.id} id={service.slug} className="jv-card p-8 flex flex-col">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <a href="#book" className="jv-btn-green !px-5 !py-2.5 text-sm">
                      Book Now
                    </a>
                  </div>
                </div>
      ...
      {rest.length > 0 && (
        <section className="jv-section bg-slate-50">
          <div className="jv-container">
            <h2 className="text-3xl font-extrabold text-slate-900 mb-8">Additional Services</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {rest.map((service) => {
                const Icon = ICON_MAP[service.icon ?? "wrench"] ?? Wrench;
                return (
                  <div key={service.id} id={service.slug} className="jv-card p-6 flex gap-4">
                    <div className="w-11 h-11 rounded-xl bg-slate-100 flex items-center justify-center shrink-0">
                      <Icon className="w-5 h-5 text-slate-700" />
                    </div>
                    <div className="flex-1">
                      <h3 className="font-bold text-slate-900 mb-1">{service.name}</h3>
                      <p className="text-sm text-slate-500 mb-3 line-clamp-2">{service.shortDesc}</p>
                      <div className="flex items-center justify-between">
                        <span className="font-bold text-slate-900 text-sm">
                          {service.price ? formatNaira(Number(service.price)) : "On Request"}
                        </span>
                        {service.duration && (
      ...
      <section className="jv-section bg-white">
        <div className="jv-container">
          <div className="text-center mb-12">
            <p className="text-green-500 font-semibold text-sm uppercase tracking-wider mb-2">How It Works</p>
            <h2 className="text-4xl font-extrabold text-slate-900">Simple. Fast. Reliable.</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              { step: "01", title: "Book Online", desc: "Choose your service and preferred date using our simple booking form." },
              { step: "02", title: "Drop Off", desc: "Bring your eBike to our Victoria Island workshop at your booked time." },
              { step: "03", title: "We Service It", desc: "Our certified technicians get to work with genuine parts and diagnostic tools." },
              { step: "04", title: "Pick Up & Ride", desc: "Collect your bike, fully serviced and ready to tackle Lagos again." },
            ].map((item) => (
      ...
      <section id="book" className="jv-section bg-slate-50">
        <div className="jv-container max-w-2xl">
          <div className="text-center mb-10">
            <p className="text-green-500 font-semibold text-sm uppercase tracking-wider mb-2">Get Started</p>
            <h2 className="text-4xl font-extrabold text-slate-900">Book a Service</h2>
            <p className="text-slate-500 mt-3">Fill in the form and our team will confirm your appointment within 2 hours.</p>
          </div>
