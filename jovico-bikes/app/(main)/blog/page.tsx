    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-slate-950">
        <div className="jv-container">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold text-white mb-4">The Jovico Blog</h1>
        ...
        <div className="jv-container">
          {posts.length === 0 ? (
            <div className="text-center py-20">
              ...
              <p className="text-slate-500">Check back soon — we publish new content every week.</p>
            </div>
          ) : (
            <>
              {/* Featured post */}
                  ...
                  <div className="jv-card overflow-hidden grid md:grid-cols-2 gap-0">
                    ...
                    <div className="p-8 md:p-10 flex flex-col justify-center">
                      <div className="flex items-center gap-2 mb-4">
                        <span className="jv-badge bg-green-100 text-green-700 text-xs">Featured</span>
                        <span className="jv-badge bg-slate-100 text-slate-600 text-xs">{featured.category}</span>
                      </div>
                      ...
                      <div className="flex items-center gap-4 text-xs text-slate-400 mb-5">
                        ...
                        <span className="flex items-center gap-1">
                          <Eye className="w-3.5 h-3.5" /> {featured.views.toLocaleString()} views
                        </span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {rest.map((post) => (
                  <Link key={post.id} href={`/blog/${post.slug}`} className="group jv-card bg-white overflow-hidden">
