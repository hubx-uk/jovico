              ...
              {tags.length > 0 && (
                <div className="jv-card p-5">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {tags.map((tag) => (
                      <span key={tag} className="jv-badge bg-slate-100 text-slate-600 text-xs">
                        #{tag}
                      </span>
                    ))}
                  </div>
        ...
        <section className="jv-section bg-slate-50">
          <div className="jv-container">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {related.map((p) => (
                <Link key={p.id} href={`/blog/${p.slug}`} className="group jv-card bg-white overflow-hidden">
                  ...
                  <div className="p-5">
                    <span className="jv-badge bg-slate-100 text-slate-500 text-xs mb-2">{p.category}</span>
