                    ...
                    <div className='grid lg:grid-cols-2 gap-12 lg:gap-6 items-center'>
                        ...
                        <div>
                            ...
                            <p className='text-slate-400 text-lg md:text-xl leading-relaxed mb-10 max-w-md'>
                                ...
                                electric bikes, built for Lagos roads and backed by expert
                                servicing.
                            </p>
                        ...
                        <div className='relative flex items-center justify-center'>
                            ...
                            <div className='relative w-full max-w-lg aspect-square'>
                                ...
                                {/* Feature pills */}
                                <div
                                    className='absolute top-8 -left-4 bg-white rounded-2xl shadow-xl px-4 py-3 flex items-center gap-2.5 animate-float'
                                ...
                                <div
                                    className='absolute bottom-12 -right-4 bg-white rounded-2xl shadow-xl px-4 py-3 flex items-center gap-2.5 animate-float'
