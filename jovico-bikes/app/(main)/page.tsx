          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-6 items-center">
            ...
            <div className="hidden md:flex relative items-center justify-center">
              ...
              <div className="relative w-full max-w-lg aspect-square">
                ...
                <div className="hidden lg:flex absolute top-8 -left-4 bg-white rounded-2xl shadow-xl px-4 py-3 items-center gap-2.5 animate-float" style={{ animationDelay: "0.5s" }}>
                ...
                <div className="hidden lg:flex absolute bottom-12 -right-4 bg-white rounded-2xl shadow-xl px-4 py-3 items-center gap-2.5 animate-float" style={{ animationDelay: "1s" }}>
