...
import {
  ArrowRight, Zap, Shield, Star, Wrench, ChevronRight,
  Battery, Wind, MapPin, Clock, CheckCircle2, Users,
  TrendingUp, Award
} from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-6 items-center">
            ...
            <div>
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-white leading-[1.05] mb-6">
                ...
                <br />
                Ride{" "}
                <span className="text-slate-300">Lagos.</span>
              </h1>

              <p className="text-slate-400 text-lg md:text-xl leading-relaxed mb-10 max-w-md">
                Beat the traffic. Skip the fuel queue. Discover Nigeria's finest
                electric bikes, built for Lagos roads and backed by expert servicing.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href="/services" className="jv-btn-secondary !border-slate-600 !text-slate-300 hover:!bg-slate-800 hover:!text-white text-base !px-8 !py-4">
                  Book a Service
                </Link>
              </div>

              {/* Stats */}
              <div className="flex flex-wrap gap-8 mt-14 pt-10 border-t border-slate-800">
                {[
            ...
            <div className="relative flex items-center justify-center">
              ...
              <div className="relative w-full max-w-lg aspect-square">
                ...
                {/* Bike emoji placeholder — replace with actual product image */}
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-9xl mb-4 animate-float">🚴</div>
                    <div className="text-white/60 text-sm font-medium">Jovico City Cruiser Pro</div>
                    <div className="text-green-400 font-bold">₦485,000</div>
                  </div>
                </div>

                {/* Feature pills */}
                <div className="absolute top-8 -left-4 bg-white rounded-2xl shadow-xl px-4 py-3 flex items-center gap-2.5 animate-float" style={{ animationDelay: "0.5s" }}>
                ...
                <div className="absolute bottom-12 -right-4 bg-white rounded-2xl shadow-xl px-4 py-3 flex items-center gap-2.5 animate-float" style={{ animationDelay: "1s" }}>
                  <div className="w-8 h-8 rounded-xl bg-slate-100 flex items-center justify-center">
                    <Wind className="w-4 h-4 text-slate-700" />
                  </div>
                  <div>
                    <div className="text-xs text-slate-500">Top Speed</div>
                    <div className="text-sm font-bold text-slate-900">35km/h</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="bg-green-500 py-4 overflow-hidden">
        <div className="flex animate-marquee whitespace-nowrap">
          {Array.from({ length: 6 }).map((_, i) => (
            <span key={i} className="flex items-center gap-8 mx-8 text-white font-semibold text-sm">
      ...
      <section className="jv-section bg-white">
        <div className="jv-container">
          <div className="flex items-end justify-between mb-12">
            ...
            <Link href="/shop" className="hidden md:flex items-center gap-1 text-sm font-semibold text-slate-700 hover:text-green-500 transition-colors">
      ...
      <section className="jv-section bg-slate-50">
        <div className="jv-container">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900">
              Built for Lagos.<br />Built to Last.
            </h2>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-slate-500 text-lg leading-relaxed mb-8">
                ...
                Whether it's a basic tune-up or a full motor overhaul — our certified
                technicians have you covered.
              </p>

              <div className="space-y-3 mb-8">
                {services.map((service) => (
                  <div key={service.id} className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 hover:bg-slate-100 transition-colors">
            ...
            <div className="relative">
              <div className="aspect-square max-w-lg mx-auto rounded-[2.5rem] bg-gradient-to-br from-slate-900 to-slate-700 overflow-hidden flex items-center justify-center">
                <div className="text-center text-white">
                  ...
                  <p className="text-slate-400 text-sm">Lagos's Best eBike Technicians</p>
                </div>
              </div>
        ...
        <div className="jv-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={testimonial.name} className="bg-slate-800/50 rounded-3xl p-7 border border-slate-700/50">
        ...
        <section className="jv-section bg-white">
          <div className="jv-container">
            <div className="flex items-end justify-between mb-12">
              ...
              <Link href="/blog" className="hidden md:flex items-center gap-1 text-sm font-semibold text-slate-700 hover:text-green-500 transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {posts.map((post) => (
                <Link key={post.id} href={`/blog/${post.slug}`} className="group jv-card overflow-hidden">
      ...
      <section className="py-20 bg-green-500">
        <div className="jv-container text-center">
          ...
          <p className="text-green-100 text-lg mb-8 max-w-xl mx-auto">
            Visit our Victoria Island showroom or browse online. Test rides available by appointment.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/shop" className="inline-flex items-center justify-center gap-2 rounded-full bg-white text-green-700 font-bold px-8 py-4 text-base hover:bg-green-50 transition-colors">
              Shop Now <ArrowRight className="w-5 h-5" />
            </Link>
            <Link href="/contact" className="inline-flex items-center justify-center gap-2 rounded-full bg-transparent text-white font-bold px-8 py-4 text-base border-2 border-white/50 hover:border-white hover:bg-white/10 transition-colors">
              Contact Us
            </Link>
          </div>
        </div>
