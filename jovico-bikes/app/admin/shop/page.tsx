            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-100 bg-slate-50">
                  <th className="text-left px-6 py-3.5 font-semibold text-slate-600">Product</th>
                  <th className="text-left px-4 py-3.5 font-semibold text-slate-600">SKU</th>
              ...
              <tbody className="divide-y divide-slate-50">
                {products.map((product) => (
                  <tr key={product.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-4 py-4">
                      <AdminToggleProduct id={product.id} published={product.published} />
                    </td>
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <AdminDeletePost id={product.id} title={product.name} resource="products" />
                      </div>
                    </td>
                  </tr>
                ))}
