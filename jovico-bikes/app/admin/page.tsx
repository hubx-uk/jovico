...
export default async function AdminDashboard() {
    ...
    return (
        <div className='max-w-7xl mx-auto'>
            ...
            {/* Stats Grid — 2 col on phone, 3 on tablet, 6 on desktop */}
            <div className='grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-3 md:gap-4 mb-8'>
                {stats.map((stat) => (
                    ...
                    >
                        <div
                            className={`w-9 h-9 rounded-xl ${stat.color} flex items-center justify-center mb-3`}
                        >
                            ...
                            {recentOrders.map((order) => (
                                ...
                                >
                                    ...
                                    <div className='text-right shrink-0'>
                                        ...
                                        <span
                                            className={`text-[10px] font-semibold px-2 py-0.5 rounded-full ${statusColors[order.status]}`}
                                        >
                                            {order.status}
                                        </span>
                                    </div>
