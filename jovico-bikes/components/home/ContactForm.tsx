  ...
  if (sent) {
    return (
      <div className="jv-card p-10 text-center">
        ...
        <p className="text-slate-500">We'll respond within 24 hours. Check WhatsApp for faster responses.</p>
      </div>
    );
  }
  ...
  return (
    <div className="jv-card p-8">
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div>
            ...
            <div className="relative">
              ...
              <input type="text" name="name" required placeholder="Your name" className="jv-input pl-10" />
            </div>
          </div>
          <div>
            ...
            <div className="relative">
              ...
              <input type="tel" name="phone" placeholder="+234..." className="jv-input pl-10" />
            </div>
          </div>
        </div>
        <div>
          ...
          <div className="relative">
            ...
            <input type="email" name="email" required placeholder="you@email.com" className="jv-input pl-10" />
          </div>
        </div>
        <div>
        ...
        <button type="submit" disabled={loading} className="jv-btn-primary w-full justify-center text-base !py-4">
