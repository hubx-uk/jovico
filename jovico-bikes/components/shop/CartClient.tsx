'use client'
// components/shop/CartClient.tsx
...
export function CartClient({ whatsapp }: { whatsapp: string }) {
                        ...
                        <div className='grid lg:grid-cols-[1fr_340px] gap-8'>
                            ...
                            <div>
                                <div className='jv-card p-6 sticky top-24'>
                                    ...
                                    <a
                                        href={`https://wa.me/${whatsapp.replace(/\D/g, '')}?text=Hi! I'd like to order: ${cart.map((i) => `${i.name} x${i.quantity}`).join(', ')}. Total: ${formatNaira(total)}`}
                                        target='_blank'
