...
const FIELDS = [
  ...
  { key: "address", label: "Physical Address", type: "text", placeholder: "14 Adeola Odeku, VI Lagos" },
  { key: "whatsapp", label: "WhatsApp Number (no spaces, include country code)", type: "text", placeholder: "+2348012345678" },
  { key: "instagram", label: "Instagram URL", type: "url", placeholder: "https://instagram.com/jovicobikes" },
  { key: "twitter", label: "Twitter URL", type: "url", placeholder: "https://twitter.com/jovicobikes" },
  { key: "facebook", label: "Facebook URL", type: "url", placeholder: "https://facebook.com/jovicobikes" },
];
