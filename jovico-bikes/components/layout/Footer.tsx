        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-6 max-w-xs">
              Lagos's premier eBike destination. We sell, service and support electric bikes
              built for Nigerian roads and lifestyles.
            </p>
            <div className="space-y-2 text-sm text-slate-400">
              ...
              <a href="mailto:hello@jovicobikes.com" className="flex items-center gap-2 hover:text-white transition-colors">
